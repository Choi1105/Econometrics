...
% R^2 -> 상수항 빼고 나머지 0인지 아닌지만 쓸수있는 Special One
Wald_R2_nu = R2/(k-1);
wald_R2_de = (1-R2)/(T-k);
Wald_R2 = Wald_R2_nu/wald_R2_de;
P_val_Wald_R2 = 1 - cdf('f', F_val, k-1 , T - k);



%F_MA(i,:) = [  F_val , Wald , Wald_R2];
%P_MA(i,:) = [ P_val_F , P_val_Wald, P_val_Wald_R2 ];
%end
